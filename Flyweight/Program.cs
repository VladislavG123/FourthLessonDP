...
namespace Conceptual
{
    ...
    public class Flyweight
    {
        ...
        public void Operation(Car uniqueState)
        {
            ...
            Console.WriteLine($"Flyweight: Displaying shared {sharedStateJson} and unique {uniqueStateJson} state.");
        }
    }
    ...
    class Program
    {
        ...
        static public void AddCarToPoliceDatabase(FlyweightFactory factory, Car car)
        {
